...
exports.RegistryAbi = [
    {
        inputs: [{ internalType: 'address', name: '_postDeployOwner', type: 'address' }],
    ...
    },
    {
        ...
        inputs: [
            ...
            { indexed: false, internalType: 'uint256', name: 'reserveMin', type: 'uint256' },
            { indexed: false, internalType: 'uint256[]', name: 'standards', type: 'uint256[]' },
    ...
    {
        anonymous: false,
        inputs: [{ indexed: true, internalType: 'address', name: 'engine', type: 'address' }],
        name: 'EngineChange',
        type: 'event',
    },
    {
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: true, internalType: 'address', name: 'exchange', type: 'address' },
            { indexed: true, internalType: 'address', name: 'adapter', type: 'address' },
            { indexed: false, internalType: 'bool', name: 'takesCustody', type: 'bool' },
            { indexed: false, internalType: 'bytes4[]', name: 'sigs', type: 'bytes4[]' },
        ],
    ...
    {
        anonymous: false,
        inputs: [{ indexed: false, internalType: 'uint256', name: 'incentiveAmount', type: 'uint256' }],
    ...
    {
        anonymous: false,
        inputs: [{ indexed: true, internalType: 'address', name: 'MGM', type: 'address' }],
        name: 'MGMChange',
        type: 'event',
    },
    {
        anonymous: false,
        inputs: [{ indexed: true, internalType: 'address', name: 'mlnToken', type: 'address' }],
        name: 'MlnTokenChange',
        type: 'event',
    },
    {
        anonymous: false,
        inputs: [{ indexed: true, internalType: 'address', name: 'nativeAsset', type: 'address' }],
        name: 'NativeAssetChange',
        type: 'event',
    },
    {
        anonymous: false,
        inputs: [{ indexed: true, internalType: 'address', name: 'priceSource', type: 'address' }],
        name: 'PriceSourceChange',
        type: 'event',
    },
    {
        anonymous: false,
        inputs: [{ indexed: true, internalType: 'address', name: 'version', type: 'address' }],
    ...
    },
    {
        ...
        outputs: [
            ...
            { internalType: 'uint256', name: 'reserveMin', type: 'uint256' },
        ],
        stateMutability: 'view',
        type: 'function',
    },
    ...
    {
        inputs: [{ internalType: 'address[]', name: '_fees', type: 'address[]' }],
        name: 'deregisterFees',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
    ...
    },
    {
        inputs: [
            ...
            { internalType: 'uint256', name: '_reserveMin', type: 'uint256' },
            { internalType: 'uint256[]', name: '_standards', type: 'uint256[]' },
    ...
    },
    {
        inputs: [
            ...
            { internalType: 'address', name: '_adapter', type: 'address' },
            { internalType: 'bool', name: '_takesCustody', type: 'bool' },
            { internalType: 'bytes4[]', name: '_sigs', type: 'bytes4[]' },
        ],
    ...
    },
    {
        inputs: [
            { internalType: 'address', name: '_adapter', type: 'address' },
            { internalType: 'uint256', name: '_adapterIndex', type: 'uint256' },
        ],
    ...
    {
        inputs: [{ internalType: 'address', name: '_MGM', type: 'address' }],
        name: 'setMGM',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
    ...
    {
        inputs: [{ internalType: 'address', name: '_mlnToken', type: 'address' }],
        name: 'setMlnToken',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
    ...
    {
        inputs: [{ internalType: 'address', name: '_nativeAsset', type: 'address' }],
        name: 'setNativeAsset',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
    ...
    {
        inputs: [{ internalType: 'address', name: '_priceSource', type: 'address' }],
        name: 'setPriceSource',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
