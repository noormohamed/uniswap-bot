...
exports.PerformanceFeeAbi = [
    {
        anonymous: false,
        inputs: [
            { indexed: true, internalType: 'address', name: 'feeManager', type: 'address' },
            { indexed: true, internalType: 'uint256', name: 'hwm', type: 'uint256' },
        ],
    ...
    },
    {
        inputs: [],
        name: 'feeAmount',
        outputs: [{ internalType: 'uint256', name: 'feeInShares', type: 'uint256' }],
