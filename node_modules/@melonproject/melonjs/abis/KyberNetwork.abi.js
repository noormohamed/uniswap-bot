...
exports.KyberNetworkAbi = [
    ...
    },
    {
        ...
        inputs: [
            { name: 'reserve', type: 'address' },
            { name: 'isPermissionless', type: 'bool' },
        ],
        name: 'addReserve',
        outputs: [{ name: '', type: 'bool' }],
        payable: false,
    ...
    },
    {
        ...
        inputs: [
            { name: 'token', type: 'address' },
            { name: 'optionalAmount', type: 'uint256' },
        ],
        name: 'getReservesRates',
        outputs: [
            { name: 'buyReserves', type: 'address[]' },
            { name: 'buyRates', type: 'uint256[]' },
            { name: 'sellReserves', type: 'address[]' },
            { name: 'sellRates', type: 'uint256[]' },
        ],
        payable: false,
        stateMutability: 'view',
        type: 'function',
    ...
    },
    {
        ...
        inputs: [
            ...
            { indexed: false, name: 'isPermissionless', type: 'bool' },
        ],
    ...
    },
    {
        ...
        inputs: [
            ...
            { indexed: false, name: 'currentContract', type: 'address' },
        ],
    ...
    },
    {
        ...
        inputs: [
            ...
            { indexed: false, name: 'negligibleRateDiff', type: 'uint256' },
        ],
    ...
    },
    {
        ...
        inputs: [
            ...
            { indexed: false, name: 'ethWeiValue', type: 'uint256' },
            { indexed: false, name: 'reserve1', type: 'address' },
            { indexed: false, name: 'reserve2', type: 'address' },
            { indexed: false, name: 'hint', type: 'bytes' },
        ],
        name: 'KyberTrade',
        type: 'event',
    },
