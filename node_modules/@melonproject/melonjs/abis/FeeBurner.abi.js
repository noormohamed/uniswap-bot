...
exports.FeeBurnerAbi = [
    ...
    },
    {
        inputs: [
            ...
            { name: '_kncToken', type: 'address' },
            { name: '_kyberNetwork', type: 'address' },
            { name: '_initialKncToEthRatePrecision', type: 'uint256' },
        ],
        payable: false,
        stateMutability: 'nonpayable',
        type: 'constructor',
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, name: 'ethToKncRatePrecision', type: 'uint256' },
            { indexed: false, name: 'kyberEthKnc', type: 'uint256' },
            { indexed: false, name: 'kyberKncEth', type: 'uint256' },
            { indexed: false, name: 'updater', type: 'address' },
        ],
        name: 'KNCRateSet',
        type: 'event',
    },
