...
exports.AssetWhitelistAbi = [
    ...
    {
        anonymous: false,
        inputs: [{ indexed: false, internalType: 'address[]', name: 'ones', type: 'address[]' }],
        name: 'ListAddition',
        type: 'event',
    },
    {
    ...
    },
    {
        inputs: [],
        name: 'position',
        outputs: [{ internalType: 'enum AssetWhitelist.Applied', name: '', type: 'uint8' }],
        stateMutability: 'pure',
        type: 'function',
    },
    {
