...
exports.signatureUtils = {
     ...
     */
    isValidSignatureAsync: function (supportedProvider, data, signature, signerAddress, exchangeAddress) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6: return [4 /*yield*/, exports.signatureUtils.isValidValidatorSignatureAsync(provider, data, signature, signerAddress, exchangeAddress)];
                    case 7:
                        isValid = _b.sent();
                        return [2 /*return*/, isValid];
                    case 8:
                        {
                            return [2 /*return*/, exports.signatureUtils.isValidPresignedSignatureAsync(provider, data, signerAddress, exchangeAddress)];
                        }
                        _b.label = 9;
     ...
     */
    isValidPresignedSignatureAsync: function (supportedProvider, data, signerAddress, exchangeAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var provider, exchangeContract, web3Wrapper, networkId, addresses, isValid;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.isHexString('data', data);
                        assert_1.assert.isETHAddressHex('signerAddress', signerAddress);
                        if (!(exchangeAddress !== undefined)) return [3 /*break*/, 1];
                        assert_1.assert.isETHAddressHex('exchange', exchangeAddress);
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3: return [4 /*yield*/, exchangeContract.preSigned.callAsync(data, signerAddress)];
                    case 4:
                        isValid = _a.sent();
                        return [2 /*return*/, isValid];
                }
    ...
    isValidWalletSignatureAsync: function (supportedProvider, data, signature, signerAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var provider, signatureWithoutType, walletContract, magicValue, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        provider = utils_1.providerUtils.standardizeOrThrow(supportedProvider);
                    ...
                    case 2:
                        magicValue = _a.sent();
                        return [2 /*return*/, magicValue === constants_1.constants.IS_VALID_WALLET_SIGNATURE_MAGIC_VALUE];
                    case 3:
                        e_1 = _a.sent();
     ...
     * @return  Whether the data was preSigned by the supplied signerAddress.
     */
    isValidValidatorSignatureAsync: function (supportedProvider, data, signature, signerAddress, exchangeAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var provider, exchangeContract, web3Wrapper, networkId, addresses, validatorSignature, isValidatorApproved, validatorContract, magicValue, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        provider = utils_1.providerUtils.standardizeOrThrow(supportedProvider);
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3:
                        validatorSignature = exports.signatureUtils.parseValidatorSignature(signature);
                    ...
                    case 4:
                        ...
                        validatorContract = new abi_gen_wrappers_1.IValidatorContract(validatorSignature.validatorAddress, provider);
                        _a.label = 5;
                    case 5:
                        _a.trys.push([5, 7, , 8]);
                    ...
                    case 6:
                        magicValue = _a.sent();
                        return [2 /*return*/, magicValue === constants_1.constants.IS_VALID_VALIDATOR_SIGNATURE_MAGIC_VALUE];
                    case 7:
                        e_2 = _a.sent();
                        return [2 /*return*/, false];
