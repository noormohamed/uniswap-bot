...
var AssetBalanceAndProxyAllowanceFetcher = /** @class */ (function () {
    function AssetBalanceAndProxyAllowanceFetcher(devUtilsContract) {
    ...
    AssetBalanceAndProxyAllowanceFetcher.prototype.getBalanceAsync = function (assetData, userAddress) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._devUtilsContract.getBalance.callAsync(userAddress, assetData)];
                    case 1:
                        balance = _a.sent();
    ...
    AssetBalanceAndProxyAllowanceFetcher.prototype.getProxyAllowanceAsync = function (assetData, userAddress) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._devUtilsContract.getAssetProxyAllowance.callAsync(userAddress, assetData)];
                    case 1:
