 ...
 */
function getNetworkIdByExchangeAddressOrThrow(exchangeAddress) {
    var e_1, _a;
    try {
        for (var _b = __values(Object.keys(networkToAddresses)), _c = _b.next(); !_c.done; _c = _b.next()) {
            var networkId = _c.value;
            if (networkToAddresses[networkId].exchange === exchangeAddress) {
                return networkId;
            }
        }
    }
    ...
    throw new Error("Unknown exchange address (" + exchangeAddress + "). No known 0x Exchange Contract deployed at this address.");
}
exports.getNetworkIdByExchangeAddressOrThrow = getNetworkIdByExchangeAddressOrThrow;
