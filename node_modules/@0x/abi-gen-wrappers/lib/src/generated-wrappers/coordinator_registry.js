...
var CoordinatorRegistryContract = /** @class */ (function (_super) {
    ...
    function CoordinatorRegistryContract(address, supportedProvider, txDefaults, logDecodeDependencies) {
        var _this = _super.call(this, 'CoordinatorRegistry', CoordinatorRegistryContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies) || this;
        /**
        ...
        _this.setCoordinatorEndpoint = {
            ...
            validateAndSendTransactionAsync: function (coordinatorEndpoint, txData) {
                return __awaiter(this, void 0, void 0, function () {
                    var txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.setCoordinatorEndpoint.callAsync(coordinatorEndpoint, txData)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, this.setCoordinatorEndpoint.sendTransactionAsync(coordinatorEndpoint, txData)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('setCoordinatorEndpoint(string)');
        ...
        _this.getCoordinatorEndpoint = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('getCoordinatorEndpoint(address)', [
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('getCoordinatorEndpoint(address)');
                // tslint:disable boolean-naming
                var abiDecodedCallData = abiEncoder.strictDecode(callData);
                return abiDecodedCallData;
            },
        ...
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(CoordinatorRegistryContract.ABI(), _this._web3Wrapper);
        return _this;
    }
    CoordinatorRegistryContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, CoordinatorRegistryContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    CoordinatorRegistryContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new CoordinatorRegistryContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    CoordinatorRegistryContract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, CoordinatorRegistryEvents);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, CoordinatorRegistryContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    CoordinatorRegistryContract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    CoordinatorRegistryContract.prototype.unsubscribeAll = function () {
     ...
     */
    CoordinatorRegistryContract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, CoordinatorRegistryContract.ABI())];
                    case 1:
                        logs = _a.sent();
