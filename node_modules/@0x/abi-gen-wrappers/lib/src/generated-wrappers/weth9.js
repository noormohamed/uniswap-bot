...
var WETH9Contract = /** @class */ (function (_super) {
    ...
    function WETH9Contract(address, supportedProvider, txDefaults, logDecodeDependencies) {
        var _this = _super.call(this, 'WETH9', WETH9Contract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies) || this;
        _this.name = {
            /**
        ...
        _this.approve = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('approve(address,uint256)', [guy.toLowerCase(), wad]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.approve.estimateGasAsync.bind(self, guy.toLowerCase(), wad))];
                            case 1:
             ...
             */
            awaitTransactionSuccessAsync: function (guy, wad, txData, pollingIntervalMs, timeoutMs) {
                var _this = this;
                assert_1.assert.isString('guy', guy);
                assert_1.assert.isBigNumber('wad', wad);
                var self = this;
                var txHashPromise = self.approve.sendTransactionAsync(guy.toLowerCase(), wad, txData);
            ...
            validateAndSendTransactionAsync: function (guy, wad, txData) {
                return __awaiter(this, void 0, void 0, function () {
                    var txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.approve.callAsync(guy, wad, txData)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, this.approve.sendTransactionAsync(guy, wad, txData)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
        ...
        _this.transferFrom = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.transferFrom.estimateGasAsync.bind(self, src.toLowerCase(), dst.toLowerCase(), wad))];
                            case 1:
                                txDataWithDefaults = _a.sent();
                                if (txDataWithDefaults.from !== undefined) {
                                    txDataWithDefaults.from = txDataWithDefaults.from.toLowerCase();
             ...
             * @returns A promise that resolves when the transaction is successful
             */
            awaitTransactionSuccessAsync: function (src, dst, wad, txData, pollingIntervalMs, timeoutMs) {
                var _this = this;
                assert_1.assert.isString('src', src);
                assert_1.assert.isString('dst', dst);
                assert_1.assert.isBigNumber('wad', wad);
                var self = this;
                var txHashPromise = self.transferFrom.sendTransactionAsync(src.toLowerCase(), dst.toLowerCase(), wad, txData);
                return new base_contract_1.PromiseWithTransactionHash(txHashPromise, (function () { return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
            ...
            validateAndSendTransactionAsync: function (src, dst, wad, txData) {
                return __awaiter(this, void 0, void 0, function () {
                    var txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.transferFrom.callAsync(src, dst, wad, txData)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, this.transferFrom.sendTransactionAsync(src, dst, wad, txData)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
        ...
        _this.withdraw = {
             ...
             * @returns A promise that resolves when the transaction is successful
             */
            awaitTransactionSuccessAsync: function (wad, txData, pollingIntervalMs, timeoutMs) {
                var _this = this;
                assert_1.assert.isBigNumber('wad', wad);
                var self = this;
                var txHashPromise = self.withdraw.sendTransactionAsync(wad, txData);
                return new base_contract_1.PromiseWithTransactionHash(txHashPromise, (function () { return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
            ...
            validateAndSendTransactionAsync: function (wad, txData) {
                return __awaiter(this, void 0, void 0, function () {
                    var txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.withdraw.callAsync(wad, txData)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, this.withdraw.sendTransactionAsync(wad, txData)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('withdraw(uint256)');
                // tslint:disable boolean-naming
                var abiDecodedCallData = abiEncoder.strictDecode(callData);
                return abiDecodedCallData;
            },
        ...
        _this.balanceOf = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('balanceOf(address)', [index_0.toLowerCase()]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _a.sent();
                                callDataWithDefaults.from = callDataWithDefaults.from
            ...
            getABIEncodedTransactionData: function (index_0) {
                assert_1.assert.isString('index_0', index_0);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('balanceOf(address)', [
                    index_0.toLowerCase(),
                ]);
                return abiEncodedTransactionData;
            },
        ...
        _this.transfer = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                assert_1.assert.isBigNumber('wad', wad);
                                self = this;
                                encodedData = self._strictEncodeArguments('transfer(address,uint256)', [dst.toLowerCase(), wad]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.transfer.estimateGasAsync.bind(self, dst.toLowerCase(), wad))];
                            case 1:
                                txDataWithDefaults = _a.sent();
                                if (txDataWithDefaults.from !== undefined) {
                                    txDataWithDefaults.from = txDataWithDefaults.from.toLowerCase();
             ...
             * @returns A promise that resolves when the transaction is successful
             */
            awaitTransactionSuccessAsync: function (dst, wad, txData, pollingIntervalMs, timeoutMs) {
                var _this = this;
                assert_1.assert.isString('dst', dst);
                assert_1.assert.isBigNumber('wad', wad);
                var self = this;
                var txHashPromise = self.transfer.sendTransactionAsync(dst.toLowerCase(), wad, txData);
                return new base_contract_1.PromiseWithTransactionHash(txHashPromise, (function () { return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
            ...
            validateAndSendTransactionAsync: function (dst, wad, txData) {
                return __awaiter(this, void 0, void 0, function () {
                    var txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.transfer.callAsync(dst, wad, txData)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, this.transfer.sendTransactionAsync(dst, wad, txData)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
        ...
        _this.deposit = {
             ...
             * @returns A promise that resolves when the transaction is successful
             */
            awaitTransactionSuccessAsync: function (txData, pollingIntervalMs, timeoutMs) {
                var _this = this;
                var self = this;
                var txHashPromise = self.deposit.sendTransactionAsync(txData);
                return new base_contract_1.PromiseWithTransactionHash(txHashPromise, (function () { return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
            ...
            validateAndSendTransactionAsync: function (txData) {
                return __awaiter(this, void 0, void 0, function () {
                    var txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.deposit.callAsync(txData)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, this.deposit.sendTransactionAsync(txData)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('deposit()');
                // tslint:disable boolean-naming
                var abiDecodedCallData = abiEncoder.strictDecode(callData);
                return abiDecodedCallData;
            },
