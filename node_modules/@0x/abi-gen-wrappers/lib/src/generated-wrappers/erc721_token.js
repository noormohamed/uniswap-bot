...
var ERC721TokenContract = /** @class */ (function (_super) {
    ...
    function ERC721TokenContract(address, supportedProvider, txDefaults, logDecodeDependencies) {
        var _this = _super.call(this, 'ERC721Token', ERC721TokenContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies) || this;
        /**
        ...
        _this.getApproved = {
             ...
             */
            getABIEncodedTransactionData: function (_tokenId) {
                assert_1.assert.isBigNumber('_tokenId', _tokenId);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('getApproved(uint256)', [_tokenId]);
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('getApproved(uint256)');
        ...
        _this.approve = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.approve.estimateGasAsync.bind(self, _approved.toLowerCase(), _tokenId))];
                            case 1:
             ...
             */
            awaitTransactionSuccessAsync: function (_approved, _tokenId, txData, pollingIntervalMs, timeoutMs) {
                var _this = this;
                assert_1.assert.isString('_approved', _approved);
                assert_1.assert.isBigNumber('_tokenId', _tokenId);
                var self = this;
                var txHashPromise = self.approve.sendTransactionAsync(_approved.toLowerCase(), _tokenId, txData);
            ...
            validateAndSendTransactionAsync: function (_approved, _tokenId, txData) {
                return __awaiter(this, void 0, void 0, function () {
                    var txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.approve.callAsync(_approved, _tokenId, txData)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, this.approve.sendTransactionAsync(_approved, _tokenId, txData)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
        ...
        _this.transferFrom = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.transferFrom.estimateGasAsync.bind(self, _from.toLowerCase(), _to.toLowerCase(), _tokenId))];
                            case 1:
                                txDataWithDefaults = _a.sent();
                                if (txDataWithDefaults.from !== undefined) {
                                    txDataWithDefaults.from = txDataWithDefaults.from.toLowerCase();
             ...
             * @returns A promise that resolves when the transaction is successful
             */
            awaitTransactionSuccessAsync: function (_from, _to, _tokenId, txData, pollingIntervalMs, timeoutMs) {
                var _this = this;
                assert_1.assert.isString('_from', _from);
                assert_1.assert.isString('_to', _to);
                assert_1.assert.isBigNumber('_tokenId', _tokenId);
                var self = this;
                var txHashPromise = self.transferFrom.sendTransactionAsync(_from.toLowerCase(), _to.toLowerCase(), _tokenId, txData);
                return new base_contract_1.PromiseWithTransactionHash(txHashPromise, (function () { return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
            ...
            validateAndSendTransactionAsync: function (_from, _to, _tokenId, txData) {
                return __awaiter(this, void 0, void 0, function () {
                    var txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.transferFrom.callAsync(_from, _to, _tokenId, txData)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, this.transferFrom.sendTransactionAsync(_from, _to, _tokenId, txData)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
        ...
        _this.safeTransferFrom1 = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                assert_1.assert.isBigNumber('_tokenId', _tokenId);
                                self = this;
                                encodedData = self._strictEncodeArguments('safeTransferFrom(address,address,uint256)', [
                                    _from.toLowerCase(),
                                    _to.toLowerCase(),
                                    _tokenId,
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.safeTransferFrom1.estimateGasAsync.bind(self, _from.toLowerCase(), _to.toLowerCase(), _tokenId))];
                            case 1:
                                txDataWithDefaults = _a.sent();
                                if (txDataWithDefaults.from !== undefined) {
                                    txDataWithDefaults.from = txDataWithDefaults.from.toLowerCase();
            ...
            awaitTransactionSuccessAsync: function (_from, _to, _tokenId, txData, pollingIntervalMs, timeoutMs) {
                ...
                assert_1.assert.isBigNumber('_tokenId', _tokenId);
                var self = this;
                var txHashPromise = self.safeTransferFrom1.sendTransactionAsync(_from.toLowerCase(), _to.toLowerCase(), _tokenId, txData);
                return new base_contract_1.PromiseWithTransactionHash(txHashPromise, (function () { return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
            ...
            validateAndSendTransactionAsync: function (_from, _to, _tokenId, txData) {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.safeTransferFrom1.callAsync(_from, _to, _tokenId, txData)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, this.safeTransferFrom1.sendTransactionAsync(_from, _to, _tokenId, txData)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
            ...
            getABIEncodedTransactionData: function (_from, _to, _tokenId) {
                ...
                assert_1.assert.isBigNumber('_tokenId', _tokenId);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('safeTransferFrom(address,address,uint256)', [
                    _from.toLowerCase(),
                    _to.toLowerCase(),
                    _tokenId,
                ]);
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('safeTransferFrom(address,address,uint256)');
                // tslint:disable boolean-naming
                var abiDecodedCallData = abiEncoder.strictDecode(callData);
                return abiDecodedCallData;
            },
        ...
        _this.ownerOf = {
            ...
            getABIEncodedTransactionData: function (_tokenId) {
                assert_1.assert.isBigNumber('_tokenId', _tokenId);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('ownerOf(uint256)', [_tokenId]);
                return abiEncodedTransactionData;
            },
            /**
             * Decode the ABI-encoded transaction data into its input arguments
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('ownerOf(uint256)');
                // tslint:disable boolean-naming
                var abiDecodedCallData = abiEncoder.strictDecode(callData);
                return abiDecodedCallData;
            },
        ...
        _this.setApprovalForAll = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('setApprovalForAll(address,bool)', [
                                    _operator.toLowerCase(),
                                    _approved,
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.setApprovalForAll.estimateGasAsync.bind(self, _operator.toLowerCase(), _approved))];
                            case 1:
                                txDataWithDefaults = _a.sent();
                                if (txDataWithDefaults.from !== undefined) {
                                    txDataWithDefaults.from = txDataWithDefaults.from.toLowerCase();
             ...
             * @returns A promise that resolves when the transaction is successful
             */
            awaitTransactionSuccessAsync: function (_operator, _approved, txData, pollingIntervalMs, timeoutMs) {
                var _this = this;
                assert_1.assert.isString('_operator', _operator);
                assert_1.assert.isBoolean('_approved', _approved);
                var self = this;
                var txHashPromise = self.setApprovalForAll.sendTransactionAsync(_operator.toLowerCase(), _approved, txData);
                return new base_contract_1.PromiseWithTransactionHash(txHashPromise, (function () { return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
            ...
            validateAndSendTransactionAsync: function (_operator, _approved, txData) {
                return __awaiter(this, void 0, void 0, function () {
                    var txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.setApprovalForAll.callAsync(_operator, _approved, txData)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, this.setApprovalForAll.sendTransactionAsync(_operator, _approved, txData)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
            ...
            getABIEncodedTransactionData: function (_operator, _approved) {
                ...
                assert_1.assert.isBoolean('_approved', _approved);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('setApprovalForAll(address,bool)', [
                    _operator.toLowerCase(),
                    _approved,
                ]);
                return abiEncodedTransactionData;
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('setApprovalForAll(address,bool)');
                // tslint:disable boolean-naming
                var abiDecodedCallData = abiEncoder.strictDecode(callData);
                return abiDecodedCallData;
            },
        ...
        _this.safeTransferFrom2 = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('safeTransferFrom(address,address,uint256,bytes)', [
                                    _from.toLowerCase(),
                                    _to.toLowerCase(),
                                    _tokenId,
                                    _data,
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.safeTransferFrom2.estimateGasAsync.bind(self, _from.toLowerCase(), _to.toLowerCase(), _tokenId, _data))];
                            case 1:
                                txDataWithDefaults = _a.sent();
                                if (txDataWithDefaults.from !== undefined) {
                                    txDataWithDefaults.from = txDataWithDefaults.from.toLowerCase();
             ...
             * @returns A promise that resolves when the transaction is successful
             */
            awaitTransactionSuccessAsync: function (_from, _to, _tokenId, _data, txData, pollingIntervalMs, timeoutMs) {
                var _this = this;
                assert_1.assert.isString('_from', _from);
                assert_1.assert.isString('_to', _to);
                assert_1.assert.isBigNumber('_tokenId', _tokenId);
                assert_1.assert.isString('_data', _data);
                var self = this;
                var txHashPromise = self.safeTransferFrom2.sendTransactionAsync(_from.toLowerCase(), _to.toLowerCase(), _tokenId, _data, txData);
                return new base_contract_1.PromiseWithTransactionHash(txHashPromise, (function () { return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
            ...
            validateAndSendTransactionAsync: function (_from, _to, _tokenId, _data, txData) {
                return __awaiter(this, void 0, void 0, function () {
                    var txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.safeTransferFrom2.callAsync(_from, _to, _tokenId, _data, txData)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, this.safeTransferFrom2.sendTransactionAsync(_from, _to, _tokenId, _data, txData)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
            ...
            getABIEncodedTransactionData: function (_from, _to, _tokenId, _data) {
                ...
                assert_1.assert.isString('_data', _data);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('safeTransferFrom(address,address,uint256,bytes)', [_from.toLowerCase(), _to.toLowerCase(), _tokenId, _data]);
                return abiEncodedTransactionData;
            },
            /**
             * Decode the ABI-encoded transaction data into its input arguments
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('safeTransferFrom(address,address,uint256,bytes)');
                // tslint:disable boolean-naming
                var abiDecodedCallData = abiEncoder.strictDecode(callData);
                return abiDecodedCallData;
            },
        ...
        _this.isApprovedForAll = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('isApprovedForAll(address,address)', [
                                    _owner.toLowerCase(),
                                    _operator.toLowerCase(),
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
             ...
             * @returns The ABI encoded transaction data as a string
             */
            getABIEncodedTransactionData: function (_owner, _operator) {
                assert_1.assert.isString('_owner', _owner);
                assert_1.assert.isString('_operator', _operator);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('isApprovedForAll(address,address)', [
                    _owner.toLowerCase(),
                    _operator.toLowerCase(),
                ]);
                return abiEncodedTransactionData;
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('isApprovedForAll(address,address)');
                // tslint:disable boolean-naming
                var abiDecodedCallData = abiEncoder.strictDecode(callData);
                return abiDecodedCallData;
            },
