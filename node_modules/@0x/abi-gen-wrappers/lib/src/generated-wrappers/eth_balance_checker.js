...
var EthBalanceCheckerContract = /** @class */ (function (_super) {
    __extends(EthBalanceCheckerContract, _super);
    function EthBalanceCheckerContract(address, supportedProvider, txDefaults, logDecodeDependencies) {
        var _this = _super.call(this, 'EthBalanceChecker', EthBalanceCheckerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies) || this;
        /**
         * Batch fetches ETH balances
         */
        _this.getEthBalances = {
            /**
             ...
             */
            callAsync: function (addresses, callData, defaultBlock) {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('getEthBalances(address[])', [addresses]);
                            ...
                            case 2:
                                ...
                                abiEncoder = self._lookupAbiEncoder('getEthBalances(address[])');
             ...
             */
            getABIEncodedTransactionData: function (addresses) {
                assert_1.assert.isArray('addresses', addresses);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('getEthBalances(address[])', [addresses]);
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('getEthBalances(address[])');
    ...
    EthBalanceCheckerContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, EthBalanceCheckerContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    EthBalanceCheckerContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("EthBalanceChecker successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new EthBalanceCheckerContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    EthBalanceCheckerContract.ABI = function () {
        var abi = [
            {
                constant: true,
                inputs: [
    ...
    return EthBalanceCheckerContract;
}(base_contract_1.BaseContract));
exports.EthBalanceCheckerContract = EthBalanceCheckerContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=eth_balance_checker.js.map