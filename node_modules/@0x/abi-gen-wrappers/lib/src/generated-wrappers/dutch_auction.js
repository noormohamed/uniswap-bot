...
var DutchAuctionContract = /** @class */ (function (_super) {
    ...
    function DutchAuctionContract(address, supportedProvider, txDefaults, logDecodeDependencies) {
        var _this = _super.call(this, 'DutchAuction', DutchAuctionContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies) || this;
        /**
        ...
        _this.getAuctionDetails = {
            ...
            validateAndSendTransactionAsync: function (order, txData) {
                return __awaiter(this, void 0, void 0, function () {
                    var txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.getAuctionDetails.callAsync(order, txData)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, this.getAuctionDetails.sendTransactionAsync(order, txData)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('getAuctionDetails((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes))');
        ...
        _this.matchOrders = {
            ...
            validateAndSendTransactionAsync: function (buyOrder, sellOrder, buySignature, sellSignature, txData) {
                return __awaiter(this, void 0, void 0, function () {
                    var txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.matchOrders.callAsync(buyOrder, sellOrder, buySignature, sellSignature, txData)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, this.matchOrders.sendTransactionAsync(buyOrder, sellOrder, buySignature, sellSignature, txData)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('matchOrders((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes),(address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes),bytes,bytes)');
                // tslint:disable boolean-naming
                var abiDecodedCallData = abiEncoder.strictDecode(callData);
                return abiDecodedCallData;
            },
    ...
    DutchAuctionContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies, _exchange) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, DutchAuctionContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, _exchange)];
            });
        });
    };
    DutchAuctionContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies, _exchange) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new DutchAuctionContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
