...
var IAssetProxyContract = /** @class */ (function (_super) {
    ...
    function IAssetProxyContract(address, supportedProvider, txDefaults, logDecodeDependencies) {
        var _this = _super.call(this, 'IAssetProxy', IAssetProxyContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies) || this;
        /**
    ...
    IAssetProxyContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, IAssetProxyContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    IAssetProxyContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("IAssetProxy successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new IAssetProxyContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    IAssetProxyContract.ABI = function () {
        var abi = [
            {
                constant: false,
                inputs: [
...
//# sourceMappingURL=i_asset_proxy.js.map