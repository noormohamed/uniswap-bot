...
var DummyERC20TokenContract = /** @class */ (function (_super) {
    ...
    function DummyERC20TokenContract(address, supportedProvider, txDefaults, logDecodeDependencies) {
        var _this = _super.call(this, 'DummyERC20Token', DummyERC20TokenContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies) || this;
        _this.name = {
            /**
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('name()');
        ...
        _this.approve = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('approve(address,uint256)', [
                                    _spender.toLowerCase(),
                                    _value,
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.approve.estimateGasAsync.bind(self, _spender.toLowerCase(), _value))];
                            case 1:
            ...
            awaitTransactionSuccessAsync: function (_spender, _value, txData, pollingIntervalMs, timeoutMs) {
                ...
                assert_1.assert.isBigNumber('_value', _value);
                var self = this;
                var txHashPromise = self.approve.sendTransactionAsync(_spender.toLowerCase(), _value, txData);
            ...
            validateAndSendTransactionAsync: function (_spender, _value, txData) {
                return __awaiter(this, void 0, void 0, function () {
                    var txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.approve.callAsync(_spender, _value, txData)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, this.approve.sendTransactionAsync(_spender, _value, txData)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
            ...
            getABIEncodedTransactionData: function (_spender, _value) {
                ...
                assert_1.assert.isBigNumber('_value', _value);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('approve(address,uint256)', [
                    _spender.toLowerCase(),
                    _value,
                ]);
                return abiEncodedTransactionData;
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('approve(address,uint256)');
                // tslint:disable boolean-naming
                var abiDecodedCallData = abiEncoder.strictDecode(callData);
                return abiDecodedCallData;
            },
        ...
        _this.totalSupply = {
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('totalSupply()');
                // tslint:disable boolean-naming
                var abiDecodedCallData = abiEncoder.strictDecode(callData);
                return abiDecodedCallData;
            },
        ...
        _this.transferFrom = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                assert_1.assert.isBigNumber('_value', _value);
                                self = this;
                                encodedData = self._strictEncodeArguments('transferFrom(address,address,uint256)', [
                                    _from.toLowerCase(),
                                    _to.toLowerCase(),
                                    _value,
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.transferFrom.estimateGasAsync.bind(self, _from.toLowerCase(), _to.toLowerCase(), _value))];
                            case 1:
                                txDataWithDefaults = _a.sent();
                                if (txDataWithDefaults.from !== undefined) {
                                    txDataWithDefaults.from = txDataWithDefaults.from.toLowerCase();
            ...
            awaitTransactionSuccessAsync: function (_from, _to, _value, txData, pollingIntervalMs, timeoutMs) {
                ...
                assert_1.assert.isBigNumber('_value', _value);
                var self = this;
                var txHashPromise = self.transferFrom.sendTransactionAsync(_from.toLowerCase(), _to.toLowerCase(), _value, txData);
                return new base_contract_1.PromiseWithTransactionHash(txHashPromise, (function () { return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
            ...
            validateAndSendTransactionAsync: function (_from, _to, _value, txData) {
                return __awaiter(this, void 0, void 0, function () {
                    var txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.transferFrom.callAsync(_from, _to, _value, txData)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, this.transferFrom.sendTransactionAsync(_from, _to, _value, txData)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
            ...
            getABIEncodedTransactionData: function (_from, _to, _value) {
                ...
                assert_1.assert.isBigNumber('_value', _value);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('transferFrom(address,address,uint256)', [
                    _from.toLowerCase(),
                    _to.toLowerCase(),
                    _value,
                ]);
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('transferFrom(address,address,uint256)');
                // tslint:disable boolean-naming
                var abiDecodedCallData = abiEncoder.strictDecode(callData);
                return abiDecodedCallData;
            },
        ...
        _this.decimals = {
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('decimals()');
                // tslint:disable boolean-naming
                var abiDecodedCallData = abiEncoder.strictDecode(callData);
                return abiDecodedCallData;
            },
        ...
        _this.balanceOf = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('balanceOf(address)', [_owner.toLowerCase()]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _a.sent();
                                callDataWithDefaults.from = callDataWithDefaults.from
            ...
            getABIEncodedTransactionData: function (_owner) {
                assert_1.assert.isString('_owner', _owner);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('balanceOf(address)', [_owner.toLowerCase()]);
                return abiEncodedTransactionData;
            },
            /**
             * Decode the ABI-encoded transaction data into its input arguments
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('balanceOf(address)');
                // tslint:disable boolean-naming
                var abiDecodedCallData = abiEncoder.strictDecode(callData);
                return abiDecodedCallData;
            },
        ...
        _this.symbol = {
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('symbol()');
                // tslint:disable boolean-naming
                var abiDecodedCallData = abiEncoder.strictDecode(callData);
                return abiDecodedCallData;
            },
        ...
        _this.mint = {
            ...
            validateAndSendTransactionAsync: function (_value, txData) {
                return __awaiter(this, void 0, void 0, function () {
                    var txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.mint.callAsync(_value, txData)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, this.mint.sendTransactionAsync(_value, txData)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('mint(uint256)');
                // tslint:disable boolean-naming
                var abiDecodedCallData = abiEncoder.strictDecode(callData);
                return abiDecodedCallData;
            },
        ...
        _this.transfer = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                assert_1.assert.isBigNumber('_value', _value);
                                self = this;
                                encodedData = self._strictEncodeArguments('transfer(address,uint256)', [_to.toLowerCase(), _value]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.transfer.estimateGasAsync.bind(self, _to.toLowerCase(), _value))];
                            case 1:
                                txDataWithDefaults = _a.sent();
                                if (txDataWithDefaults.from !== undefined) {
                                    txDataWithDefaults.from = txDataWithDefaults.from.toLowerCase();
            ...
            awaitTransactionSuccessAsync: function (_to, _value, txData, pollingIntervalMs, timeoutMs) {
                ...
                assert_1.assert.isBigNumber('_value', _value);
                var self = this;
                var txHashPromise = self.transfer.sendTransactionAsync(_to.toLowerCase(), _value, txData);
                return new base_contract_1.PromiseWithTransactionHash(txHashPromise, (function () { return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
            ...
            validateAndSendTransactionAsync: function (_to, _value, txData) {
                return __awaiter(this, void 0, void 0, function () {
                    var txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.transfer.callAsync(_to, _value, txData)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, this.transfer.sendTransactionAsync(_to, _value, txData)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
            ...
            getABIEncodedTransactionData: function (_to, _value) {
                ...
                assert_1.assert.isBigNumber('_value', _value);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('transfer(address,uint256)', [
                    _to.toLowerCase(),
                    _value,
                ]);
                return abiEncodedTransactionData;
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('transfer(address,uint256)');
                // tslint:disable boolean-naming
                var abiDecodedCallData = abiEncoder.strictDecode(callData);
                return abiDecodedCallData;
            },
        ...
        _this.allowance = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                self = this;
                                encodedData = self._strictEncodeArguments('allowance(address,address)', [
                                    _owner.toLowerCase(),
                                    _spender.toLowerCase(),
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
            ...
            getABIEncodedTransactionData: function (_owner, _spender) {
                ...
                assert_1.assert.isString('_spender', _spender);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('allowance(address,address)', [
                    _owner.toLowerCase(),
                    _spender.toLowerCase(),
                ]);
                return abiEncodedTransactionData;
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('allowance(address,address)');
                // tslint:disable boolean-naming
                var abiDecodedCallData = abiEncoder.strictDecode(callData);
                return abiDecodedCallData;
            },
        ...
        _this.setBalance = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                assert_1.assert.isBigNumber('_value', _value);
                                self = this;
                                encodedData = self._strictEncodeArguments('setBalance(address,uint256)', [
                                    _target.toLowerCase(),
                                    _value,
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.setBalance.estimateGasAsync.bind(self, _target.toLowerCase(), _value))];
                            case 1:
                                txDataWithDefaults = _a.sent();
                                if (txDataWithDefaults.from !== undefined) {
                                    txDataWithDefaults.from = txDataWithDefaults.from.toLowerCase();
            ...
            awaitTransactionSuccessAsync: function (_target, _value, txData, pollingIntervalMs, timeoutMs) {
                ...
                assert_1.assert.isBigNumber('_value', _value);
                var self = this;
                var txHashPromise = self.setBalance.sendTransactionAsync(_target.toLowerCase(), _value, txData);
                return new base_contract_1.PromiseWithTransactionHash(txHashPromise, (function () { return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
            ...
            validateAndSendTransactionAsync: function (_target, _value, txData) {
                return __awaiter(this, void 0, void 0, function () {
                    var txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.setBalance.callAsync(_target, _value, txData)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, this.setBalance.sendTransactionAsync(_target, _value, txData)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
            ...
            getABIEncodedTransactionData: function (_target, _value) {
                ...
                assert_1.assert.isBigNumber('_value', _value);
                var self = this;
                var abiEncodedTransactionData = self._strictEncodeArguments('setBalance(address,uint256)', [
                    _target.toLowerCase(),
                    _value,
                ]);
                return abiEncodedTransactionData;
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('setBalance(address,uint256)');
                // tslint:disable boolean-naming
                var abiDecodedCallData = abiEncoder.strictDecode(callData);
                return abiDecodedCallData;
            },
        ...
        _this.MAX_MINT_AMOUNT = {
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('MAX_MINT_AMOUNT()');
                // tslint:disable boolean-naming
                var abiDecodedCallData = abiEncoder.strictDecode(callData);
                return abiDecodedCallData;
            },
        ...
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(DummyERC20TokenContract.ABI(), _this._web3Wrapper);
        return _this;
    }
    DummyERC20TokenContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies, _name, _symbol, _decimals, _totalSupply) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, DummyERC20TokenContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, _name, _symbol, _decimals, _totalSupply)];
            });
        });
    };
    DummyERC20TokenContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies, _name, _symbol, _decimals, _totalSupply) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = __read(base_contract_1.BaseContract._formatABIDataItemList(constructorAbi.inputs, [_name, _symbol, _decimals, _totalSupply], base_contract_1.BaseContract._bigNumberToString), 4), _name = _a[0], _symbol = _a[1], _decimals = _a[2], _totalSupply = _a[3];
                        iface = new ethers.utils.Interface(abi);
                        deployInfo = iface.deployFunction;
                        txData = deployInfo.encode(bytecode, [_name, _symbol, _decimals, _totalSupply]);
                    ...
                    case 3:
                        ...
                        contractInstance = new DummyERC20TokenContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    DummyERC20TokenContract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, DummyERC20TokenEvents);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, DummyERC20TokenContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    DummyERC20TokenContract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    DummyERC20TokenContract.prototype.unsubscribeAll = function () {
     ...
     */
    DummyERC20TokenContract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, DummyERC20TokenContract.ABI())];
                    case 1:
                        logs = _a.sent();
