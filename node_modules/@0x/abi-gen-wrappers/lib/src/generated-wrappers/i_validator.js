...
var IValidatorContract = /** @class */ (function (_super) {
    ...
    function IValidatorContract(address, supportedProvider, txDefaults, logDecodeDependencies) {
        var _this = _super.call(this, 'IValidator', IValidatorContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies) || this;
        /**
        ...
        _this.isValidSignature = {
            ...
            getABIDecodedTransactionData: function (callData) {
                var self = this;
                var abiEncoder = self._lookupAbiEncoder('isValidSignature(bytes32,address,bytes)');
    ...
    IValidatorContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, IValidatorContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    IValidatorContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new IValidatorContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    IValidatorContract.ABI = function () {
        var abi = [
            {
                constant: true,
                inputs: [
